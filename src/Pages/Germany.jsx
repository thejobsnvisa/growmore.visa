...
const Germany = () => {
  const url = "https://www.growmoreglobalvisa.com/Germany";
  ...
  return (
    <>
      <Helmet>
        <title>
          Germany to Germany | Skilled Occupation List with GrowMore Immigration
        </title>

        <meta
          name="description"
          content="Growmore Immigration can assist you in migrating to Germany. Check the latest Skilled Occupation List, eligibility criteria, and expert migration support to start your journey today."
        />
        ...
        <meta
          property="og:title"
          content="Germany to Germany | Skilled Occupation List with GrowMore Immigration"
        />
        <meta
        ...
        <section className="bg-[#28535B] py-16 md:py-20">
          <div className="max-w-[1400px] mx-auto px-6 md:px-15">
            <h1 className="text-3xl md:text-5xl font-semibold text-white mb-3">
              Begin Your Study Abroad Journey in Germany
            </h1>
            <p className="text-white font-semibold">Home &gt; Germany</p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-12 grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <h2 className="text-xl md:text-4xl normal text-gray-900 leading-tight mb-6 mt-6">
                ...
                of Studying in the Germany
              </h2>

              <p className="text-[#727272] font-medium leading-relaxed  max-w-xl text-justify">
                Germany is one of the world’s most powerful and reliable
                destinations for higher education, offering international
                students a compelling combination of globally recognised
                education, industry-driven learning, affordability, and
                long-term career security. Renowned for its academic excellence
                and research leadership, Germany’s universities emphasise
                practical, application-oriented teaching closely aligned with
                industry needs, making graduates highly employable. As Europe’s
                largest economy and a global leader in engineering, automotive,
                artificial intelligence, IT, renewable energy, healthcare, and
                manufacturing, Germany provides exceptional career opportunities
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div className="flex items-start gap-4 border border-white rounded-xl p-4 shadow-md hover:shadow-lg transition">
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-base text-white mt-1">
                      Annual job openings in Germany across various industries.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 border border-white rounded-xl p-4 shadow-md hover:shadow-lg transition sm:col-span-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-base text-white mt-1">
                      An 18-month post-study job search visa, Schengen access to
                      27 countries, and a high PR success rate make it an ideal
                      study destination.
                    </p>
                  </div>
                </div>
