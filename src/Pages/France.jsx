...
const France = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          France to France | Skilled Occupation List with GrowMore Immigration
        </title>
        ...
        <section className="bg-[#28535B] py-16 md:py-20">
          <div className="max-w-[1400px] mx-auto px-6 md:px-15">
            <h1 className="text-3xl md:text-5xl font-semibold text-white mb-3">
              Begin Your Study Abroad Journey in France
            </h1>
            <p className="text-white font-semibold">Home &gt; France</p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-12 grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-[#727272] font-medium leading-relaxed  max-w-xl text-justify">
                ...
                France, exploring the country’s skilled migration pathways,
                family sponsorships, or student visas can open doors to
                permanent residency and a prosperous future. Discover why France
                could be the perfect destination for your next big move.
              </p>
            </div>
          </div>
        </section>
