...
const Australia = () => {
  const url = "https://www.growmoreglobalvisa.com/australia";
  ...
  return (
    <>
      <Helmet>
        <title>
          Australia to Australia | Skilled Occupation List with GrowMore
          Immigration
        </title>
        ...
        <meta
          property="og:title"
          content="Australia to Australia | Skilled Occupation List with GrowMore Immigration"
        />
        <meta
        ...
        <section className="bg-[#28535B] py-16 md:py-20">
          <div className="max-w-[1400px] mx-auto px-6 md:px-15">
            <h1 className="text-3xl md:text-5xl font-semibold text-white mb-3">
              Begin Your Study Abroad Journey in Australia
            </h1>
            <p className="text-white font-semibold">Home &gt; Australia</p>
          </div>
        </section>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div className="flex items-start gap-4 border border-white rounded-xl p-4 shadow-md hover:shadow-lg transition sm:col-span-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm md:text-base text-white mt-1">
                      Job opportunities available across Australia with strong
                      demand in Healthcare, IT, Hospitality and Retail
                    </p>
                  </div>
                </div>
              </div>
